...
export default function ContactContent() {
  ...
  return (
    <div className="container mx-auto px-4 py-12">
      <h1 className="font-[var(--font-playfair)] text-3xl font-bold text-brown mb-8 text-center">Contato</h1>
      ...
      <div className="max-w-lg mx-auto">
        <h2 className="font-[var(--font-playfair)] text-2xl font-bold text-brown mb-6 text-center">
          Envie uma Mensagem
        </h2>
        {sent ? (
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label htmlFor="contato-nome" className="text-sm text-gray-600 mb-1 block">Nome *</label>
              <Input id="contato-nome" value={name} onChange={(e) => setName(e.target.value)} required />
            </div>
            <div>
              <label htmlFor="contato-email" className="text-sm text-gray-600 mb-1 block">E-mail *</label>
              <Input id="contato-email" type="email" value={email} onChange={(e) => setEmail(e.target.value)} required />
            </div>
            <div>
              <label htmlFor="contato-tel" className="text-sm text-gray-600 mb-1 block">Telefone</label>
              <Input id="contato-tel" value={phone} onChange={(e) => setPhone(e.target.value)} />
            </div>
            <div>
              <label htmlFor="contato-msg" className="text-sm text-gray-600 mb-1 block">Mensagem *</label>
              <textarea
                id="contato-msg"
                value={message}
